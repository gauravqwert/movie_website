...
const Sidebar = () => {
  return (
    <div className="-translate-y-10 flex h-screen fixed mt-10 border-r-2 border-[#242424]">
      <aside className="text-white w-45 flex-shrink-0">
        <ul className="py-4">
          <li className="text-lg  bg-gradient-to-b from-green-500 to-lime-400 rounded-full -translate-x-5">
            <Link
          ...
          <li className="text-lg -translate-x-10 hover:bg-gradient-to-b from-green-500 to-lime-400 rounded-full">
